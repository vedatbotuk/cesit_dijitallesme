...
class ButtonSwitch:
    ...
    def add_callback(self, mode, callback):
        ...
        if mode == 'falling':
            GPIO.add_event_detect(self.gpio_no, GPIO.FALLING, callback=callback, bouncetime=75)
        elif mode == 'both':
            GPIO.add_event_detect(self.gpio_no, GPIO.BOTH, callback=callback, bouncetime=75)
        elif mode == 'rising':
            GPIO.add_event_detect(self.gpio_no, GPIO.RISING, callback=callback, bouncetime=75)
